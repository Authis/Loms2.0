...
<body  >
 <form id="quicklinksfrm" method="post">
...
<p class="title">QUICK LINKS</p> 
 <a href="#" onclick="javascript:onclickaction('quicklinksfrm','login.action')"><div class="back"></div></a>
 </div>
<!-- <div id="content-header">-->
<!--  <table width="75%" >-->
<!--  <tr>-->
<!--     <td align="right" width="1%">-->
<!--       <img src="/loms/view/images/Quick Links.png"  width="70" height="70"  style="vertical-align: middle;border: 0px" />   -->
<!--     </td>-->
...
<!---->
<!---->
<!--       <a href="#" onclick="javascript:onclickaction('quicklinksfrm','login.action')">-->
...
<p>&nbsp;</p>
 ...
 <tr align="left"> 
   <td>
      <div class="link-box">
        <div class="link-heading" align="left"><a href="#" onclick="javascript:onclickaction('quicklinksfrm','viewCase.action');"><u>Search Cases and Case Hearing Information</u></a></div>
        <div class="link-descr">Search Cases and Case Hearing Information quickly here</div>
      </div>
    </td> 
 </tr>
 </s:if>
