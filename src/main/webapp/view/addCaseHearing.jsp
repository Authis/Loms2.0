...
<body onload="javascript:doOnLoad();popOnload();">
 <form id="addcasehearinfrm" name="addcasehearinfrm" action="addCaseHearSave.action" method="post">
...
<s:if test="%{retMsg != '' && retMsg != 'E9999' && mailErrorStr == 'Sent'}">
		<tr>
			...
			<div class="succ">Case Hearing has been added Successfully. Kindly Check your mail. <s:hidden name="retMsg" id="retMsg" />
			<b><a href="#" onclick="javascript:goToAddCase('addcasehearinfrm','addcasedocmenu.action');" >Click here to Add Case Document</a></b></div>
			</div>
			</td>
		</tr>
 </s:if>
...
<s:if test="%{retMsg != '' && retMsg != 'E9999' && mailErrorStr == ''}">
		<tr>
			...
			<b><a href="#" onclick="javascript:goToAddCase('addcasehearinfrm','addcasedocmenu.action');" >Click here to Add Case Document</a></b>
 ...
 <s:if test="%{retMsg == 'E9999'}">
  ...
  <tr>
	<td>Case ID:</td>
	<td><s:textfield theme="simple" readonly="true" name="hidcaseid" id="txtCaseId" cssStyle="width: 200px;"></s:textfield> </td>
		  
</tr>
<tr>
	<td>Client ID:</td>
	<td><s:textfield theme="simple" readonly="true" name="hidclientid" id="txtClientId" cssStyle="width: 200px;"></s:textfield> </td>
		  
</tr>
<tr>
	<td>Case Hearing Date:<span class="mandi">*</span></td>
	<td><s:textfield theme="simple"  name="caseHearingBean.casehearingdate" id="txtHearingDate" readonly="true" cssStyle="width: 200px;">  </s:textfield>
	  
	</td>
</tr>
<tr>
	<td>Comments:</td>
	<td><s:textarea theme="simple"  name="caseHearingBean.casehearingcomments" id="txtComment" cssStyle="width: 200px;" ></s:textarea> </td>
 </tr>
<tr>&nbsp;</tr> 
...
<input type="button" name="groovybtn1" class="groovybutton" value="Back" onclick="javascript:onclickaction('addcasehearinfrm','searchCaseInforesult.action')" /></td></tr>
