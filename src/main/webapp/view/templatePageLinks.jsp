...
<!--       <img src="/loms/view/images/Case Filing Templates.png"  width="75" height="72"  style="vertical-align: middle;border: 0px" />   -->
<!--     </td>-->
...
<p>&nbsp;</p>
 ...
 <tr align="left"> 
   <td>
      <div class="link-box">
        <div class="link-heading" align="left"><a href="#" onclick="javascript:onclickaction('judgmentlinksfrm','caseFillingTemplateDownload.action');"> <u>Download Case Filing Templates and Coding Sheets</u> </a></div>
        <div class="link-descr">Search and Download Standard Case Filing Templates and Coding Sheets here</div>
      </div>
    </td> 
 </tr>
 ...
 <tr align="left"> 
   <td>
      <div class="link-box">
        <div class="link-heading" align="left"><a href="#" onclick="javascript:onclickaction('judgmentlinksfrm','formTemplateDownload.action');"> <u>Download Forms</u> </a></div>
        <div class="link-descr">Search and Download Forms here</div>
      </div>
    </td> 
 </tr>
  </s:if>
