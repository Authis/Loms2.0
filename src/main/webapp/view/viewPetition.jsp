...
<body onload="javascript:doOnLoad();">
 <form id="frmviewpetition" name="frmviewpetition" action="searchPetition.action" method="post">
...
<table border="0" align="center" width="100%" height="100%" cellspacing="5" cellpadding="5" class="user_max_input">
 <tr> 
	<td colspan="2"><div id="frmviewpetition_errorloc" class="error_strings"></div></td>
	<td align="right"> </td>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("frmviewpetition");
