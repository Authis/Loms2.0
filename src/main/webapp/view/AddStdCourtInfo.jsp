...
<form id="addcourtinfo" name="addcourtinfo"
	action="addCourtInfoSave.action" method="post">
...
<!--    <tr>      -->
<!--       <td align="right" >-->
<!--       <a href="/loms/view/PDF/Add Court Information.pdf" target="_blank">-->
<!--       <img src="/loms/view/images/Help-icon.png" width="20" height="20" border="0" alt="Help?" />  -->
<!--       </a>-->
<!--       -->
<!--        <a href="#" onclick="javascript:onclickaction('addcourtinfo','lawStandardManagement.action')">-->
...
<p class="title">Add Court Information</p> 
 <a href="#" onclick="javascript:onclickaction('addcourtinfo','lawStandardManagement.action')"><div class="back"></div></a>
</div>
...
<table border="0" width="50%" style="border-color: gray"  cellpadding="10" cellspacing="10">
	...
	<tr>
		...
		<td><s:select theme="simple" name="addCourtInfoBean.courtstate" id="txtCourtState"
			...
			cssStyle="width:200px;" onchange="javascript:onclickaction('addcourtinfo','stdCrtInfoState.action');"></s:select></td>
	</tr>
	<tr>
