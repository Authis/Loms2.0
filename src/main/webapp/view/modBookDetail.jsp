...
<form id="editbookfrm" name="editbookfrm"
	action="editBookSave.action" method="post">
 <s:hidden name="bookBean.bookId"></s:hidden>
...
<!--    <tr>      -->
<!--       <td align="right" >-->
<!--       <a href="/loms/view/PDF/Update Book Information.pdf" target="_blank">-->
<!--       <img src="/loms/view/images/Help-icon.png" width="20" height="20" border="0" alt="Help?" />  -->
<!--       </a>-->
<!--       -->
<!--       -->
<!--          <a href="#" onclick="javascript:onclickaction('editbookfrm','bookManagement.action')">-->
...
<p class="title">Modify Book</p> 
 <a href="#"  onclick="javascript:onclickaction('editbookfrm','bookManagement.action')"><div class="back"></div></a>
</div>
<div style="float: right;"><a href="/loms/view/PDF/Update Book Information.pdf" target="_blank">
       <img src="/loms/view/images/Help-icon.png" width="20" height="20" border="0" alt="Help?" />  
       </a></div> 
...
<table border="0" width="100%" style="border-color: gray" cellpadding="10" cellspacing="10">
	<s:if test="%{retBookId != '' && retBookId != 'E9999'}">
		<tr>
			<td colspan="4"><div id="statusMsg1" style="display: inline;" ><div class="succ">Book details has been edited Successfully. <s:hidden name="retBookId" id="retBookId" />
			</div></div></td>
		</tr>
	</s:if>
	<s:if test="%{retBookId == 'E9999'}">
		<tr>
			<td colspan="4"><div id="statusMsg2" style="display: inline;" ><div class="err">Book details has not been edited Successfully. <s:hidden name="retBookId" id="retBookId" />
			</div></div></td>
		</tr>
	</s:if>
	...
	<tr>
		<td colspan="2">
		<div id="editbookfrm_errorloc" class="error_strings"></div>
		</td>
		<td></td>
	</tr>
    <!--   <tr>
		<td>Book Id:</td>
		<td><s:textfield theme="simple"	name="bookBean.bookId" id="txtbookNoIN" readonly="true" cssStyle="width: 200px;"></s:textfield>
		 </td>
	</tr>-->
	<tr>
		<td>Book Title:<span class="mandi">*</span></td>
		<td><s:textfield theme="simple"
			name="bookBean.bookTitleIN" maxlength="50" id="txtbookTitleIN" cssStyle="width: 200px;">
		</s:textfield></td>
	</tr>
	<tr>
		<td>Book Rack No:<span class="mandi">*</span></td>
		<td><s:textfield theme="simple" name="bookBean.bookRackNoIN"
			id="txtbookRackNoIN" maxlength="15" cssStyle="width: 200px;">
		</s:textfield>  </td>
	</tr> 
	...
	<tr>
		...
		<td><s:textfield theme="simple" name="bookBean.bookRowNoIN" cssStyle="width: 200px;" 
			id="txtbookRowNoIN" ></s:textfield></td>
	</tr>
	
	<tr>
		<td>Book Position:<span class="mandi">*</span></td>
		<td><s:textfield theme="simple"	name="bookBean.bookNoIN" id="txtbookNoIN" cssStyle="width: 200px;"></s:textfield>
		 </td>
	</tr>
	...
	<tr>
		...
		<td><s:textfield theme="simple" maxlength="50" name="bookBean.bookAuthorIN"
			id="txtbookAuthorIN" cssStyle="width: 200px;"></s:textfield></td>
	</tr>
	<tr>
		<td>Book Co-Author:</td>
		<td><s:textfield theme="simple" name="bookBean.bookCoAuthorIN"
			id="txtbookCoAuthorIN" maxlength="50" cssStyle="width: 200px;">
		</s:textfield>  </td>
	</tr>
	<tr>
		<td>Book Subject:</td>
		<td><s:textfield theme="simple" name="bookBean.bookSubjectIN"
			id="txtbookSubjectIN" maxlength="50" cssStyle="width: 200px;">
		</s:textfield>  </td>
	</tr>
	<tr>
		<td>Book Type:</td>
		<td><s:textfield theme="simple" name="bookBean.bookTypeIN"
			id="txtbookTypeIN" maxlength="50" cssStyle="width: 200px;">
		</s:textfield>  </td>
	</tr>
	<tr>
		<td>Book Year:</td>
    ...
    <tr>
		...
		<td><s:textfield theme="simple" name="bookBean.bookPublisherIN"
			id="txtbookPublisherIN" maxlength="50" cssStyle="width: 200px;">
		</s:textfield>  </td>
	</tr>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<input type="submit" name="groovybtn1" class="groovybutton"	value="Save"  onclick="javascript:statusMsg();"  /> 
			<input type="reset" name="groovybtn1" class="groovybutton" value="Reset" onclick="" />
			<input type="button" name="groovybtn1" class="groovybutton" value="Back" onclick="javascript:onclickaction('editbookfrm','searchBooks.action')" />
		</td>
	</tr>
...
<script language="JavaScript" type="text/javascript"
	...
	var frmvalidator = new Validator("editbookfrm");
