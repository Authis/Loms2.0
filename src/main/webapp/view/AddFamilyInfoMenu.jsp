...
<body onload="javascript:doOnLoad();popOnload();">
 <form id="addfaminfo" name="addfaminfo" action ="addFamInfoMenu.action" method="post">
...
<!--       <img src="/loms/view/images/BackButton1.jpg"  width="50"  style="vertical-align: middle;border: 0px" /> </a>-->
<!--       </td>-->
<!--    </tr>-->
<!--</table>-->
...
<tr> 
	...
	<tr>
				...
				<td><s:textfield theme="simple" name="addfamilyinfo.clientid" readonly="true"
					value="" id="txtClientId" cssStyle="width: 200px;" /> <a
					onclick="javascript:searchClientID('faminfo');"><img
					src="/loms/view/images/Search.png" width="25" height="20"
					alt="Search Client ID" /></a><s:textfield theme="simple" id="txtName"
					cssStyle="border:0px; background:inherit;" readonly="true" /></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
<tr>
...
<tr>
 ...
 <tr>
  ...
  <td><div style="display: none;" id="divOtherTxt"><s:textfield theme="simple"   name="txtOther" id="txtOther" maxlength="25"> </s:textfield></div></td>
   
</tr>
<tr>
	<td>Date of Birth:</td>
	<td><s:textfield theme="simple" name="addfamilyinfo.dateofbirth" id="txtDateofBirth" readonly="true" cssStyle="width: 200px;"></s:textfield>
		 
	 </td>  
</tr>
<tr>
	<td>Mobile Number:</td>
	<td><s:textfield theme="simple" name="addfamilyinfo.mobilenumber" id="txtMobileNumber" maxlength="20" cssStyle="width: 200px;"> </s:textfield></td>
</tr>
 
<tr>
	<td>Telephone Number:</td>
	<td><s:textfield theme="simple" name="addfamilyinfo.telephonenumber" id="txtTelephoneNumber" maxlength="20" cssStyle="width: 200px;"></s:textfield> </td>  
</tr>
<tr>	
	<td>Address:</td>
	<td><s:textarea theme="simple" name="addfamilyinfo.address" id="txtAddress" cssStyle="width: 200px;"></s:textarea> </td> 
</tr> 
<tr>	
...
<tr>	
	...
	<td> 
	<select name = "addfamilyinfo.maritalstatus" id="txtMaritalStatus" onchange="javascript:onMrgStat();" style="width: 210px;">
...
<tr>	
	...
	<td><div style="display: none;" id="mrglable">Marriage Date:</div></td>
	<td><div style="display: none;" id="mrgtextbox"><s:textfield theme="simple" cssStyle="width: 200px;"  name="addfamilyinfo.marriagedate" id="txtMarriageDate" readonly="true"></s:textfield>
...
<tr>
<td>&nbsp;</td>
 <td><input type="submit" name="groovybtn1" class="groovybutton" value="Add"  onclick="javascript:assOthrRelTypeValue();statusMsg();"/>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("txtMobileNumber","num_s", "Mobile No can contain only numbers");  
  frmvalidator.addValidation("txtMobileNumber", "minlen=10","Mobile No should contain a minimum of 10 digit");
  frmvalidator.addValidation("txtTelephoneNumber","num_s", "Telephone No can contain only numbers");  
