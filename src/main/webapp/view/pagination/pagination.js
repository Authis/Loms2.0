pn={
  ...
  createPaginationNav:function(table){
    ...
    //counter=counter.replace('_z_',(table.datarowsize-1)/2); // Changes made by Sunrays to get exact count
  ...
  changePaginationNav:function(table,start){
   ...
   // counter=counter.replace('_z_',table.datarowsize/2) // Changes made by Sunrays to get exact count
     counter=counter.replace('_z_',table.datarowsize) // Changes made by Sunrays to get exact count
